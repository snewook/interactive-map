import { X, MapPin, Briefcase, Compass, Cpu, BookOpen, MessageSquare } from 'lucide-react';
...
export function BusinessDetailDialog({ business, onClose }: BusinessDetailDialogProps) {
                  ...
                  <div className="space-y-4">
                    {business.excursions.map((excursion, index) => (
                      <motion.div
                        ...
                        className="flex items-start gap-4 p-4 rounded-lg bg-gray-50 hover:bg-gray-100 transition-all border-l-4"
                      ...
                      >
                        ...
                        <span className="text-gray-800 leading-relaxed pt-1">{excursion}</span>
                      </motion.div>
                    ))}
                  </div>
                </TabsContent>
